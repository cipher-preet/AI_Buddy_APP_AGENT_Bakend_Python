...
Every useful task must have a specific title and a useful body. The body should explain the task in 2-4 sentences using only confirmed current-conversation details: objective, project/context, current status, owner/date if stated, and any constraints or acceptance criteria. Never copy the title into the body.
